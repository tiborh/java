// $ANTLR 3.5.2 S001HelloWord.g 2017-03-20 00:44:14
...
public class S001HelloWordParser extends Parser {
	...
	// S001HelloWord.g:57:1: expression : SALUTATION ENDSYMBOL ;
	public final S001HelloWordParser.expression_return expression() throws RecognitionException {
		...
		try {
			// S001HelloWord.g:57:12: ( SALUTATION ENDSYMBOL )
			// S001HelloWord.g:57:14: SALUTATION ENDSYMBOL
			{
			root_0 = (Object)adaptor.nil();


			SALUTATION1=(Token)match(input,SALUTATION,FOLLOW_SALUTATION_in_expression96); 
			SALUTATION1_tree = (Object)adaptor.create(SALUTATION1);
			adaptor.addChild(root_0, SALUTATION1_tree);

			ENDSYMBOL2=(Token)match(input,ENDSYMBOL,FOLLOW_ENDSYMBOL_in_expression98); 
	...
	public static final BitSet FOLLOW_SALUTATION_in_expression96 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_ENDSYMBOL_in_expression98 = new BitSet(new long[]{0x0000000000000002L});
}
