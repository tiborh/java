// $ANTLR 3.5.2 S001HelloWord.g 2017-03-19 21:31:31
...
public class S001HelloWordLexer extends Lexer {
	...
	public final void mSALUTATION() throws RecognitionException {
		try {
			...
			// S001HelloWord.g:25:11: ( 'Hello word' )
			// S001HelloWord.g:25:12: 'Hello word'
			{
			match("Hello word"); 
	...
	public final void mENDSYMBOL() throws RecognitionException {
		try {
			int _type = ENDSYMBOL;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// S001HelloWord.g:26:10: ( '!' )
			// S001HelloWord.g:26:11: '!'
			{
			match('!'); 
			}
