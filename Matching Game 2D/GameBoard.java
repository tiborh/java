...
{   
    ...
    private void swapCards(int cardARowIndex, int cardAColumnIndex, int cardBRowIndex, int cardBColumnIndex)
    {
        ...
        Card temp_card = cards[cardARowIndex][cardAColumnIndex];
        cards[cardARowIndex][cardAColumnIndex] = cards[cardBRowIndex][cardBColumnIndex];
        cards[cardBRowIndex][cardBColumnIndex] = temp_card;
    }
    ...
    {
        // Please write your code after this line
        boolean all_matches_found = true;
        for (int i = 0; all_matches_found && i < cards.length; i++)
            for (int j = 0; all_matches_found && j < cards[i].length; j++)
