...
public class Hangman implements KeyListener
{
    ...
    private final String FILEPATH = "/usr/share/dict/words";
    private final int MAX_WORD_LIST_SIZE = count_length(FILEPATH); //this is the maximum number of words that can be loaded and stored in our word list array
    ...
    private static int count_length(String filename) throws IOException {
    ...
    public Hangman() throws IOException {
        ...
        int wordListSize = readWordList(FILEPATH, wordList);
    ...
    private String pickSecretWord(String[] wordList, int wordListSize)
    {
        ...
        return wordList[(int) (Math.random() * wordListSize)];
    }
    ...
    private String constructInitialDisplayWord(String secretWord)
    {
        ...
        for (int i = 0; i < secretWord.length(); i++)
            out_string += UNKNOWN_CHARACTER;
        //System.out.println(secretWord + " " + secretWord.length() + " " + out_string);
        return out_string;
    }
    ...
    private String updateDisplayWord(String displayWord, String secretWord, char guess)
    {
        ...
        for (int i = 0; i < secretWord.length(); i++)
            out_string += (secretWord.charAt(i) == guess) ? secretWord.charAt(i) : displayWord.charAt(i);
    ...
    {
        // Please write your code after this line
        return (displayWord.equals(secretWord) || life == 0);
    }
