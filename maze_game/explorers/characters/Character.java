...
{ 
    ...
    /*Constructor methods*/
    public Character(String otherName, String otherDescription, int otherHealth, int otherSecretWeapon)
    {
        name = otherName;
    ...
    public Character(String otherName, String otherDescription, int otherSecretWeapon)
    {
